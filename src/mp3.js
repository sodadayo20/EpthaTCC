...
const userSelect = document.getElementById('trackList');
...
playIconContainer.addEventListener('click', () => togglePlayer());
muteIconContainer.addEventListener('click', () => toggleAudio());
userSelect.addEventListener('change', e => musicChangeHandller(e))
